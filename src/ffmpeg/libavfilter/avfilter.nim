from ../types import AVFilterPad, AVMediaType, AVFilterContext, AVFilterLink, AVFilter, AVClass, AVFilterGraph, AVFilterInOut
from ../libavutil/dict import AVDictionary
from version import FF_API_PAD_COUNT
...
when FF_API_PAD_COUNT:
  proc avfilter_pad_count* (pads: ptr AVFilterPad): cint {.deprecated.}
